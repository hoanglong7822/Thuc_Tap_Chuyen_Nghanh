            ...
            <footer class="container-fluid px-4">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">Phiếu nhập kho</h2>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body" >
                                 <h4 style="text-align:center"> <b> NHẬP KHO </b></h4>
                                <table  id="datatablesSimple" >
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "
                                            SELECT * from tbl_phieunhapkho as a join tbl_nhanvien as b on a.maNV=b.maNV;";
                                        ...
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $row["maPNK"];?></td>
                                            
                                            <td><?php echo $row["tenNV"];?></td>
                                            
                                            <td><?php echo $row["ngaylap"];?></td>
                                         
                                            <td><a class="btn btn-danger" style="color:white" href="z_pnk_view_detail.php?maPNK=<?php echo $row["maPNK"];?>">Chi tiết</a>
                                            <a class="btn btn-danger" style="color:white" href="z_in_pnk.php?maPNK=<?php echo $row["maPNK"];?>">In</a>
                                        </td>
                                        </tr>
                                        <?php
                                        }
